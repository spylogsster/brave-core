...
public abstract class BraveTabGroupModelFilter extends TabModelFilter {
    ...
    /**
     * This function will be redirected to {@link TabGroupModelFilter}'s version via bytecode.
     */
    public int getRootId(Tab tab) {
        assert false : "This method should never be called, double check bytecode changes!";
        return 0;
    }
}
