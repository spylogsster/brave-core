...
| Deposits  | A deposit refers to spending a confirmation token in exchange for BAT.  |
...
| Statement of accounts  | A statement of accounts outlines the transactions during a specific period, providing an overview.  |
...
| Transactions  | Transactions are recorded in the ledger, providing a chronological and organized history of events.  |
...
| Wallet  | A wallet securely stores your Brave Rewards.  |
