...
#include "brave/components/ai_chat/core/browser/ai_chat_helper.h"
...
// ai_chat::AIChatHelperDelegate

raw_ptr<PrefService> AIChatTabHelper::GetPrefsService() const {
  return user_prefs::UserPrefs::Get(web_contents()->GetBrowserContext());
}

raw_ptr<AIChatMetrics> AIChatTabHelper::GetChatMetrics() const {
  return ai_chat_metrics_;
}

scoped_refptr<network::SharedURLLoaderFactory>
AIChatTabHelper::GetURLLoaderFactory() const {
  return web_contents()
      ->GetBrowserContext()
