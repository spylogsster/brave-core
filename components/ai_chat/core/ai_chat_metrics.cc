...
void AIChatMetrics::ReportOmniboxCounts() {
  ...
  double open_ratio_this_week = static_cast<double>(open_count_this_week) /
                                std::max(autocomplete_count_this_week, 1ul);
  ...
  double open_ratio_last_week = static_cast<double>(open_count_last_week) /
                                std::max(autocomplete_count_last_week, 1ul);
