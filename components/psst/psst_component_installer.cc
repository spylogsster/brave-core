...
class PsstComponentInstallerPolicy
 ...
 public:
  ...
  static base::NoDestructor<std::string> g_psst_component_id_;
  static base::NoDestructor<std::string> g_psst_component_base64_public_key_;
...
base::NoDestructor<std::string>
    PsstComponentInstallerPolicy::g_psst_component_id_(kPsstComponentId);
base::NoDestructor<std::string>
    PsstComponentInstallerPolicy::g_psst_component_base64_public_key_(
        kPsstComponentBase64PublicKey);
