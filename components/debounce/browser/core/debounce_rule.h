...
#ifndef BRAVE_COMPONENTS_DEBOUNCE_BROWSER_CORE_DEBOUNCE_RULE_H_
#define BRAVE_COMPONENTS_DEBOUNCE_BROWSER_CORE_DEBOUNCE_RULE_H_
...
#endif  // BRAVE_COMPONENTS_DEBOUNCE_BROWSER_CORE_DEBOUNCE_RULE_H_
